 ...
 */
/* Copyright 2015 Keith Griffiths (email : info@keithgriffiths.co.uk)
...
if(is_admin())
	{	
		function ip_dashboard_widget_function()
		{
			...
			echo "</div>\n\n";
			echo '<div class="box-ip"><hr> Your IP address is something you might rarely think about, it\'s important to know what your IP address is and when it changes. Your IP address is used to identify computers on the Internet. <hr> Want to know more about IP addresses, or to get the latest updates on this plugin, go to the "Show IP Info" using the menu on the left side. <hr>Show IP address. Latest version 1.7</div>';
		}
